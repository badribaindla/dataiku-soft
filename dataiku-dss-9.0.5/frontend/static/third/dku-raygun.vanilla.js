...
(function(window, undefined) { // NOSONAR: OK to use undefined keyword
...
var raygunFactory = function (window, $, undefined) { // NOSONAR: OK to use undefined keyword
  ...
  var Raygun =
  {
    ...
    /** Stack Trace must contain:
     *   - messsage
     *   - stack
     *     - url, line, func
     */

    sendRawException : function(stackTrace, customData,tags)  {
        processUnhandledException(stackTrace, {
          customData: typeof _customData === 'function' ?
            merge(_customData(), customData) :
            merge(_customData, customData),
          tags: mergeArray(_tags, tags)
    ...
    sendRawPayload : function(payload) {
