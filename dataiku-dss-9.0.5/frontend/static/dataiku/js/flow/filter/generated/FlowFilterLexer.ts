...
export class FlowFilterLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(FlowFilterLexer._LITERAL_NAMES, FlowFilterLexer._SYMBOLIC_NAMES, []);
	...
	constructor(input: CharStream) {
		super(input);
		this._interp = new LexerATNSimulator(FlowFilterLexer._ATN, this);
	}
	...
	@Override
	public get ruleNames(): string[] { return FlowFilterLexer.ruleNames; }

	@Override
	public get serializedATN(): string { return FlowFilterLexer._serializedATN; }

	@Override
	public get modeNames(): string[] { return FlowFilterLexer.modeNames; }

	public static readonly _serializedATN: string =
		"\x03\uAF6F\u8320\u479D\uB75C\u4880\u1605\u191C\uAB37\x02%\u0174\b\x01"+
	...
	public static get _ATN(): ATN {
		if (!FlowFilterLexer.__ATN) {
			FlowFilterLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(FlowFilterLexer._serializedATN));
		}
