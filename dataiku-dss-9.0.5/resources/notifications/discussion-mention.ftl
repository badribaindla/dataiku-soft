                    ...
                    <tbody>
                      ...
                      <tr>
                        <td colspan="2" style="padding: 40px; font-family: 'Source Sans Pro', Helvetica, arial, sans-serif; font-size: 14px; line-height: 27px; color: #666666;background-color: #FFFFFF">
                          ...
                          <div class="intro" style="margin: 20px 0px;">
                            ${intro}
                          </div>

                          <div id="message" style="font-size: 1.3em; margin: 15px 25px 30px 25px; padding: 15px; border: 1px solid #eeeeee; background: #fafafa; font-style: italic;">
                            &ldquo; ${message} &rdquo;
                          </div>
                          ...
                          <div class="instance-details">
                            ...
                            <#if dssInstanceName?has_content>
                              <strong>${dssInstanceName!}</strong>
                            </#if>
                            <#if studioExternalUrl?has_content>
                              (<a href="${studioExternalUrl}">${studioExternalUrl}</a>)
                            <#else>
                              <br />To enable links in this e-mail, ask your DSS administrator to configure the DSS URL
                            </#if>
                          </div>
