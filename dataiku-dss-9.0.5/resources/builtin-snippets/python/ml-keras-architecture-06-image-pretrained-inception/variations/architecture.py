...
def build_model(input_shapes, n_classes=None):
    ...
    base_model = InceptionV3(include_top=False, weights=None, input_tensor=image_input)
    ...
    folder = dataiku.Folder("name_of_folder_containing_inceptionv3_weights")
    weights_path = "inceptionv3_imagenet_weights_notop.h5"
