"Leave one label out" cross-validation is a cross-validation scheme which holds out the samples according to the labels (integers) coming from one of the columns of the design matrix. 
