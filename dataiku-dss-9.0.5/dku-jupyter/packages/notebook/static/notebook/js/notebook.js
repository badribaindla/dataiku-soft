...
define([
    ...
    Notebook.prototype.copy_notebook = function () {
        ...
        // Begin DKU specific: on copy, don't open a new window
        ...
        return p.then(function () {
            return that.contents.copy(that.notebook_path, parent).then(
                function (data) {
                    // Begin DKU specific: on copy, fixup the URL
                    w.top.location =  w.top.location.pathname
                        .split("/").slice(0,4).join("/") + "/jupyter/"+
                    data.name.replace(".ipynb", "") + "/"
                    // End DKU specific
     ...
     */
    Notebook.prototype.toggle_input = function() { 
        $("div.input").toggle();
    };
